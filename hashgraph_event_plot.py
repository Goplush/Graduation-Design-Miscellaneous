...
# 读取CSV文件
csv_file = "hashgraph_gossip_info.csv"
...
with open(csv_file, 'r') as file:
    ...
    for row in reader:
        ...
        timestamp = row['Gossip Runtime']
        timestamps.append(float(timestamp))
        total_events.append(int(row['Num. of Events']))
        consensus_events.append(int(row['Num. of Consensus Events']))
